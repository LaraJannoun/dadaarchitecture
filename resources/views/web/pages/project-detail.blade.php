...
<div class="project-container-background">
    <div class="slider-project-images-container">
        ...
        <div class="slider-object">
            <img class="slider-image contain" src="{{ asset($image->image) }}" alt="{{$image->title}}" />
        ...
        @else
        <div class="slider-object">
            <img class="slider-image contain" src="{{ asset($project_detail->main_image) }}" alt="{{$project_detail->title}}" />
            <div class="left-arrow"></div>
            <div class="right-arrow"></div>
        </div>
        @endif
