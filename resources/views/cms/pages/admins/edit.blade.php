                        ...
                        <form method="post" action="{{ route('admin.'.$page_info['link'].'.update', $admin) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="first_name" id="input-first-name" class="form-control form-control-alternative{{ $errors->has('first_name') ? ' is-invalid' : '' }}" placeholder="First Name" value="{{ old('first_name', $admin->first_name) }}" autofocus>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="last_name" id="input-last-name" class="form-control form-control-alternative{{ $errors->has('last_name') ? ' is-invalid' : '' }}" placeholder="Last Name" value="{{ old('last_name', $admin->last_name) }}" autofocus>
