            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col">
                            <h3 class="mb-0">Trashed {{ $page_info['title'] }}</h3>
                        </div>
                            ...
                            <td class="text-right">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        <form action="{{ route('admin.'.$page_info['link'].'.trash.destroy', $row) }}" method="post">
                                            @csrf

                                            <a class="dropdown-item" href="{{ route('admin.'.$page_info['link'].'.trash.show', $row) }}">View</a>
                                            <a class="dropdown-item" href="{{ route('admin.'.$page_info['link'].'.trash.restore', $row) }}">Restore</a>
